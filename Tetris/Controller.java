...
public class Controller {
    public static final int MOVE = Testlis.MOVE;
    public static final int SIZE = Testlis.SIZE;
    public static int XMAX = Testlis.XMAX;
    public static int YMAX = Testlis.YMAX;
    public static int [][]MESH = Testlis.MESH;
