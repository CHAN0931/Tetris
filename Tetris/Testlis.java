...
public class Testlis extends Application {
        ...
        if(lines.size() > 0)
            ...
            for (Node node: rects) {
                ...
                for(Node node: newrects) {
                    ...
                    for (Node node_a : pane.getChildren()) {
                        if (node_a instanceof Rectangle)
                            rects.add(node_a);
                    }

                    for (Node node_b : rects) {
                        Rectangle a_1 = (Rectangle) node_b;
                        try {
